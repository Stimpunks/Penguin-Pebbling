...
- **Fixes:** shared links were showing no preview image, the page was telling search engines to index an address that did not exist yet, and a stale stylesheet could survive a day after a change. All three are corrected.
